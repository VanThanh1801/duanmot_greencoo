                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                                ...
                                <form class="mx-1 mx-md-6" action="index.php?act=dangky" method="POST" id="dangky">
                                    ...
                                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                        <input type="submit" class="btn btn-primary btn-lg"
                                            name="dangky" value="Dangky"></input>
                                    </div>
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                ...
                                <img src="https://mdbootstrap.com/img/Photos/new-templates/bootstrap-registration/draw1.png" width="600px" height="500px" alt="Sample image">
