        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Thêm thành viên quản trị</h6>
                </nav>
                        ...
                        <div class="product_item">
                            ...
                            <form action="index.php?act=addadmin" method="post" enctype="multipart/form-data">
                                ...
                                <aside id="admin_sidebar" class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary btn-lg" name="addadmin"
                                            value="THÊM MỚI">
                                        <!-- <input type="reset" class="btn btn-primary btn-lg" value="NHẬP LẠI"> -->
                                        <a href="index.php?act=listtkadmin"><input type="button" class="btn btn-primary btn-lg" value="DANH SÁCH"></a>
                                    </div>
