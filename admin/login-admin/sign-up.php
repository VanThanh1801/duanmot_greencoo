      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <!-- <p class="text-lead text-white">Đăng nhập tài khoản với</p> -->
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" action="" method="POST">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  Tôi đồng ý <a href="javascript:;" class="text-dark font-weight-bolder">lỗi và điều kiện</a>
                  </label>
                </div>
                ...
                <p class="text-sm mt-3 mb-0">Bạn có sẵn  một tài khoản <a href="index.php?act=dangnhap" class="text-dark font-weight-bolder">Đăng nhập</a></p>
              </form>
            </div>  
          </div>
        </div>
