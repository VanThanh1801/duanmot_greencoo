            ...
            <div class="row">
                <div class="col-12">
                  ...
                  ?>
                    ...
                    <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $mess ?></p>
                  ...
                  <td>
                    <p class="text-xs font-weight-bold mb-0"><?= $hinh ?></p>
                      ...
                      <td class="align-middle">
                        <a href="<?= $themanh ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                         Thêm/Sửa ảnh
                        </a>
                      </td>
                    </tr>
