            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <?php 
                  foreach($listban as $banner){
                    extract($banner);
                    $delban="index.php?act=delbn&id=".$id;
                    $addban = "index.php?act=upban&id=".$id;
                    $hinhpath = "../upload/" . $img;
                  ...
                  ?>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0"><?= $text1 ?></p>
                    
                    </td>
                      <td>
                      <p class="text-xs font-weight-bold mb-0"><?= $text2 ?></p>
                    ...
                    <p class="text-xs font-weight-bold mb-0"><?php if($status == 1){
                      ...
                      <td class="align-middle">
                        <a href="<?= $delban ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                         Xóa
                        </a>
                      </td>
                      <td class="align-middle">
                        <a href="<?= $addban ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                         Sửa
                        </a>
                      </td>
                    </tr>
