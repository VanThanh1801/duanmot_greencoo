        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Thêm Banner</h6>
                </nav>
                            ...
                            <form action="index.php?act=addbanner" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-3">
                                            <label for="product-price">Chữ đi kèm CHÍNH:</label>
                                            <input type="text" name="text1" class="form-control" size="60">
                                        </div>
                                    </div>
                                    <div class="form-group row">

                                        <div class="col-xs-3">
                                            <label for="product-price">Chữ đi kèm PHỤ:</label>
                                            <input type="text" name="text2" class="form-control" size="60">
                                        </div>
                                    </div>
                                    <div class="form-group row">
