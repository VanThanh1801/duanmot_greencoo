            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Bình luận</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Danh sách Bình Luận</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h2>Danh Sách sản phẩm có bình luận</h2>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($spcmt as $socmt) {
                                            extract($socmt);
                                            $allcmt = "index.php?act=spbl&id=" . $id;
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?= $socmt ?></p>

                                                </td>
                                                <td class="align-middle">
                                                    <a href="<?= $allcmt ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Các bình luận
                                                    </a>
                                                </td>
                                            </tr>
