    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Thêm danh mục</h6>
            </nav>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <form action="index.php?act=adddm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="category-title" class="label_title">Hình ảnh</label>
                                ...
                                <div class="btn_button">
                                    ...
                                    <input name="add_category" type="submit" value="Thêm mới" class="btn_but">

                                    <a class="btn_butn" href="index.php?act=listdm">Danh sách</a>
                                </div>
